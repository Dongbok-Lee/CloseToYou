...
const Modal = ({ modalType, modalSize, modalPlaceholderFirst, modalPlaceholderSecond, setIsOpenModal, children }) => {
                ...
                <div className="modal-container">
                    ...
                    <div className="modal-down-box">
                        <div className="modal-down-input">
                            ...
                            { modalSize === 'large' && modalType !== 'delete' && <Input inputSize="medium" inputPlaceholder={ modalPlaceholderSecond }></Input>}
                            { modalType !== 'delete' && <Input inputSize="medium" inputPlaceholder={ modalPlaceholderFirst }></Input>}
                        </div>
                        <div className="modal-down-button">
                            <Button btnSize='small' onTouchStart={ handleTouchButton }>{ children }</Button> 
                        </div>
                    </div>
                </div>
            </ModalStyle>        
