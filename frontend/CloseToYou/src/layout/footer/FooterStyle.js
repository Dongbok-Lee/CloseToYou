...
const FooterStyle = styled.div`
    ...
    .footer-closet-box, .footer-hanger-box, .footer-bookmark-box, .footer-profile-box {
        display: flex;
        ...
        .footer-closet-icon-box, .footer-hanger-icon-box, .footer-bookmark-icon-box, .footer-profile-icon-box {
            width: 2.1875rem;
            height: 2.1875rem;
        }
